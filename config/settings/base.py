...
SPECTACULAR_SETTINGS = {
    "TITLE": "Citea API",
    "DESCRIPTION": "Marketplace de servicios de belleza y cuidado personal.",
    "VERSION": "0.1.0",
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "resend"  # literal: Resend usa "resend" como usuario fijo
EMAIL_HOST_PASSWORD = config("RESEND_API_KEY", default="")  # tu API key de Resend
DEFAULT_FROM_EMAIL = config(
    "DEFAULT_FROM_EMAIL", default="Citea <onboarding@resend.dev>"
)
